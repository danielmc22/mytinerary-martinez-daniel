...
itinerariesPerCity: (id) => {
    ...
    return async(dispatch, getState)=>{
        try{
            ...
            const res = await axios.get('https://mytinerary-martinez-daniel.herokuapp.com/api/itinerarios/'+id)
...
likeDislike: (itinerarioId) => {                    //recibe como parametro el ID del lugar 
    ...
    return async () => {
        try {
            let response = await axios.put(`https://mytinerary-martinez-daniel.herokuapp.com/api/itinerarios/likes/${itinerarioId}`, {}, //viene como parametro desde arriba
