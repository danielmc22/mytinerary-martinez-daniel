...
const {obtenerCiudades, cargarCiudad, borrarCiudad, modificarCiudad}=ciudadesController  /* aqui se desestructura el objeto(obtener informacion de las props de manera separada) requerido en linea 3   */
